export default function Quote() {
  return (
    <figure className="relative m-0 w-11/12 rounded-2xl border border-third-color before:absolute before:-top-4 before:left-4 before:block before:bg-[#eeeeee] before:text-6xl before:font-bold before:content-['\201c'] after:absolute after:-bottom-10 after:right-4 after:block after:bg-[#eeeeee] after:text-6xl after:font-bold after:content-['\201d'] ">
      <blockquote className="relative z-20 p-4 text-xl font-medium sm:p-8 sm:text-2xl">
