export default function Quote() {
  return (
    <figure className="relative m-0 w-full rounded-2xl border border-third-color before:absolute before:-top-4 before:left-4 before:block before:bg-[#eeeeee] before:text-6xl before:font-bold before:content-['\201c'] after:absolute after:-bottom-10 after:right-4 after:block after:bg-[#eeeeee] after:text-6xl after:font-bold after:content-['\201d'] ">
